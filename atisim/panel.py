...
# Held keys. Signs follow atisim.manual: the arrows are a centre stick, so
    ...
    def __init__(
        ...
        *,
        ...
        if getattr(self.fig.canvas, "manager", None) is not None:
            self.fig.canvas.manager.set_window_title("atisim")
...
def run_live(
    ...
    *,
    ...
    panel.fig._atisim_animation = animation
    plt.show()
