...
#
# The middle row is what makes the split readable: geometry alone moves the load
# coordinate by -7.638e-03 g and rotation with J2 by only -4.725e-04, so 94% of
# that coordinate's movement is the ellipsoid rather than the spin. Nothing about
# the vortex model changed; what moved is the state the encounter is flown FROM.
#
