...
## 5. The process finding, which is why `docs/DEVELOPMENT.md` now exists
...
`docs/DEVELOPMENT.md` rule 1 is now *"nothing is done until it is in `docs/PROJECT.md`"*, with the
