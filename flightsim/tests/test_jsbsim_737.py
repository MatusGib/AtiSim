"""Cross-code verification of flightsim against JSBSim 1.3.1, via the 737.
...
What is claimed: flightsim's aero build-up, trim solver, linearisation and
...
flightsim/tests/data/jsbsim_737_reference.xml by scripts/gen_jsbsim_reference.py.
...
# Derivatives 737.xml does not define. flightsim carries 0.0 for each, which is
...
def test_density_matches_jsbsim_to_machine_precision():
    ...
    flightsim's ISA uses geometric altitude where the standard uses
