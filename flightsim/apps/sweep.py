"""The analysis UI: sweep view and deep dive over a directory of run artifacts.
    ...
    .venv/Scripts/python.exe -m flightsim.apps.sweep runs/analysis
...
from flightsim.analysis import artifact, figures, series
...
def build_app(root: Path) -> Dash:
    ...
    app = Dash(__name__, title="flightsim analysis")
    app.layout = html.Div(
        [
            html.Div([
                html.Span("flightsim  ", style={"fontWeight": 700}),
