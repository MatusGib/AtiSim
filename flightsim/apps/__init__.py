"""Dash front ends over `flightsim.analysis`.

**This is the only package allowed to import Dash, and it computes nothing.**
Every number it displays comes from `flightsim.checks` or
`flightsim.analysis.series`, each asserted by a test. That is the protocol
